...
.\build.ps1 -Name iconlibutils -Version 1.2.3
```
...
```
<project>/.config/iconlibutils/<packaging>.build-host
$HOME/.config/iconlibutils/<packaging>.build-host
```
...
user: builder
shell: powershell
build_dir: C:/build/iconlibutils
```
